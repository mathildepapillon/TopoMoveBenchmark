"""Arm-1 reference subjects at k=11: the FULL neighborhood vocabulary.
...
Usage: python train_molecule_topk11.py DATASET
Writes results/molecule_topk11/topk11_{DATASET}.jsonl and checkpoints
under results/molecule_topk11/runs/{DATASET}_s{SEED}/.
"""
...
def main() -> None:
    ...
    out_dir = REPO / "results" / "molecule_topk11"
    out_dir.mkdir(parents=True, exist_ok=True)
    out_path = out_dir / f"topk11_{ds}.jsonl"
    done = {}
    if out_path.exists():
